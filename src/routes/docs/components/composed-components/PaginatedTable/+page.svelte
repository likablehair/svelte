...
<PropsViewer
  props={[
    ...
    { name: "page", type: "number", description: "Current page number", default: "1" },
    { name: "maxPage", type: "number", description: "Maximum number of pages", default: "undefined" },
    { name: "rowsPerPageOptions", type: "Item[]", description: "Options for rows per page.", default: "[{ label: '20', value: 20 }, { label: '50', value: 50 }, { label: '100', value: 100 }]" },
    { name: "hideRowsPerPage", type: "boolean", description: "Whether to hide the rows-per-page selector.", default: "false" },
    { name: "totalElements", type: "number | undefined", description: "Total number of elements available.", default: "undefined" },
    { name: "rowsPerPage", type: "number", description: "Number of rows shown per page.", default: "20" },
    {
      name: "filters",
      type: "Filter[]",
    ...
    { name: "searchBarColumns", type: "string[] | undefined", description: "Fields on which to perform search filtering.", default: "undefined" },
    { name: "searchBarVisible", type: "boolean", description: "Show or hide the search bar.", default: "true" },
    { name: "searchBarPlaceholder", type: "string", description: "Placeholder text for the search bar.", default: "'Type something to search...'" },
    { name: "lang", type: "'it' | 'en'", description: "Language of the UI.", default: "'en'" },
    { name: "editFilterMode", type: "'one-edit' | 'multi-edit'", description: "Mode for editing filters.", default: "'one-edit'" },
    { name: "showActiveFilters", type: "boolean", description: "Show chips representing active filters.", default: "true" },
    { name: "resizableColumns", type: "boolean", description: "Enable or disable column resizing.", default: "false" },
  ...
  slots={[
    {
      ...
      properties: [
        { name: "handleSearchChange", type: "function", description: "Handler for search input changes." }
      ]
    },
    {
      name: "footerSnippet",
      ...
      properties: [
        { name: "hideRowsPerPage", type: "boolean", description: "If true, hides the rows-per-page dropdown." },
        { name: "rowsPerPageOptions", type: "array", description: "Available options for rows per page." },
        { name: "rowsPerPageSelection", type: "function", description: "Handler for changing rows per page." },
        { name: "totalElements", type: "number", description: "Total number of elements." },
        { name: "page", type: "number", description: "Current page." },
        { name: "maxPage", type: "number", description: "Maximum number of pages." },
        { name: "rowsPerPage", type: "number", description: "Current rows per page." },
        { name: "handlePaginationChange", type: "function", description: "Handles pagination changes." }
      ]
    },
    {
      ...
      properties: [
        { name: "totalElements", type: "number", description: "Total elements count." },
        { name: "page", type: "number", description: "Current page." },
        { name: "maxPage", type: "number", description: "Maximum page number." },
        { name: "rowsPerPage", type: "number", description: "Current rows per page." }
      ]
    },
    {
  ...
  events={[
    {
      ...
      properties: [
        { name: "rowsPerPage", type: "number", description: "Number of rows per page." },
        { name: "page", type: "number", description: "Current page number." },
        { name: "builder", type: "Builder", description: "Builder with current query state." }
      ]
    },
    {
      ...
      properties: [
        { name: "builder", type: "Builder", description: "Builder with updated filter state." }
      ]
    },
    {
